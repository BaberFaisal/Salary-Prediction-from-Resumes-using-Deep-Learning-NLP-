# -*- coding: utf-8 -*-
"""Predict salaries based on resumes

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1gL3eHEvJKvBE5xXdJybG3tEpilqSHRg4

# Large scale text analysis with deep learning

We will develop a deep learning model to predict salaries based on resumes (credits to to [Oleg Vasilev](https://github.com/Omrigan/)). While we will begin this project during our seminar class, it will require additional effort on your part to finalize and submit it as homework.
"""
...
We gonna try the first method just because it's the simplest one.
"""
